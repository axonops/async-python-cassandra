...
from .benchmark_config import BenchmarkResult, BenchmarkThresholds
...
def main():
    ...
    parser.add_argument(
        "--markers", 
        default="benchmark", 
        help="Pytest markers to select benchmarks"
    )
    parser.add_argument(
        "--output", 
        type=Path, 
    ...
    # Run benchmarks
    all_passed = runner.run_benchmarks(
