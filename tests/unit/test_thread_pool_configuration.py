...
class TestThreadPoolConfiguration:
    ...
    def test_async_cluster_executor_threads_parameter(self):
        ...
        cluster = AsyncCluster(contact_points=["localhost"], executor_threads=16)
    ...
    def test_various_thread_pool_sizes(self):
        ...
        for size in test_sizes:
            cluster = AsyncCluster(contact_points=["localhost"], executor_threads=size)
    ...
    def test_executor_threads_passed_to_underlying_cluster(self, mock_cluster_class):
        ...
        # Create AsyncCluster
        AsyncCluster(contact_points=["localhost"], executor_threads=25)
    ...
    def test_custom_executor_property_access(self):
        ...
        cluster = AsyncCluster(contact_points=["localhost"], executor_threads=10)
    ...
    def test_executor_threads_explicit_configuration(self):
        ...
        assert cluster1.executor._max_workers > 0
        cluster1.shutdown()
    ...
    async def test_thread_pool_with_actual_queries(self):
        ...
        cluster = AsyncCluster(contact_points=["localhost"], executor_threads=5)
    ...
    def test_executor_threads_boundary_values(self):
        ...
        # Test minimum value
        cluster_min = AsyncCluster(contact_points=["localhost"], executor_threads=1)
        assert cluster_min._cluster.executor._max_workers == 1
        cluster_min._cluster.shutdown()

        # Test large value
        cluster_large = AsyncCluster(contact_points=["localhost"], executor_threads=100)
    ...
    def test_executor_configuration_persistence(self):
        ...
        cluster = AsyncCluster(contact_points=["localhost"], executor_threads=12)
    ...
    async def test_executor_threads_with_context_manager(self):
        ...
        async with AsyncCluster(contact_points=["localhost"], executor_threads=7) as cluster:
...
class TestThreadPoolDocumentationExamples:
    ...
    def test_documentation_example_explicit_configuration(self):
        ...
        cluster1 = AsyncCluster(contact_points=["localhost"], executor_threads=16)
        assert cluster1._cluster.executor._max_workers == 16

        cluster2 = AsyncCluster(contact_points=["localhost"], executor_threads=32)
    ...
    async def test_documentation_example_high_concurrency(self):
        ...
        cluster = AsyncCluster(contact_points=["localhost"], executor_threads=50)
