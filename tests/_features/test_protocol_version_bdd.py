...
class TestProtocolVersionBDD:
    ...
    @pytest.mark.asyncio
    async def test_legacy_protocol_rejection(self, cassandra_service):
        """
        ...
        legacy_config = {"contact_points": [cassandra_service.contact_point], "protocol_version": 3}
    ...
    @pytest.mark.asyncio
    async def test_modern_protocol_acceptance(self, cassandra_service):
        """
        ...
        modern_config = {"contact_points": [cassandra_service.contact_point], "protocol_version": 5}
    ...
    @pytest.mark.asyncio
    async def test_automatic_protocol_negotiation(self, cassandra_service):
        """
    ...
    @pytest.mark.asyncio
    async def test_cloud_provider_guidance(self, cassandra_service):
        """
    ...
    @pytest.mark.asyncio
    async def test_authentication_with_protocol_validation(self, cassandra_service):
        """
    ...
    @pytest.mark.asyncio
    async def test_future_protocol_support(self, cassandra_service):
        """
        ...
        future_config = {"contact_points": [cassandra_service.contact_point], "protocol_version": 6}
    ...
    @pytest.mark.asyncio
    async def test_migration_scenario(self, cassandra_service):
        """
