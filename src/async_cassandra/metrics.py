        ...
        async with self._lock:
            ...
            if recent_queries:
                ...
                stats = {
                    ...
                    "top_queries": dict(sorted(self.query_counts.items(), 
...
class PrometheusMetricsCollector(MetricsCollector):
    ...
    def __init__(self):
        try:
            ...
            self.connection_health = Gauge(
                'cassandra_connection_healthy',
                'Whether Cassandra connection is healthy',
                ['host']
            )
    ...
    async def record_connection_health(self, metrics: ConnectionMetrics) -> None:
        ...
        self.connection_health.labels(host=metrics.host).set(
            1 if metrics.is_healthy else 0
        )
